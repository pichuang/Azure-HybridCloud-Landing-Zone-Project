...
$vnet_spoke_name = 'aliez-vnet-spoke-aks'
...
az network vnet create --name $vnet_spoke_name --resource-group $rg_spoke_name --location $location --address-prefixes 10.200.0.0/16
