...
# Fixed name for Azure Firewall with the prefix of at least /26
az network vnet subnet create --resource-group $rg_hub_name --vnet-name $vnet_hub_name --name AzureFirewallSubnet --address-prefixes 10.0.1.0/24
...
# Fixed name for Azure Route Server with the prefix of at least /27
az network vnet subnet create --resource-group $rg_hub_name --vnet-name $vnet_hub_name --name RouteServerSubnet --address-prefixes 10.0.5.0/24
...
# Fixed name for Azure Bastion with the prefix of at least /26
az network vnet subnet create --resource-group $rg_hub_name --vnet-name $vnet_hub_name --name AzureBastionSubnet --address-prefixes 10.0.14.0/24
